...
describe("buildCurl", () => {
    ...
    it("Should build curl correctly with body", () => {
        const expected = "curl -X GET 'http://localhost:3000/api/some-endpoint' -H 'host: localhost:3000' -H 'Content-Type: application/json' -d '{\"key\":\"value\"}'";
    ...
    it("Should build curl correctly without body", () => {
        const expected = "curl -X GET 'http://localhost:3000/api/some-endpoint' -H 'host: localhost:3000' -H 'Content-Type: application/json' ";
