...
import { makeTimeLineListPEC_CancelledNotification } from './TimelineElementCancelledNotificationTimelineEvents';
...
const makeTimelineListPEC =
  ...
  (index: number, recipient: NotificationRecipient): ReadonlyArray<TimelineElementV20> =>
    ...
    ] : makeTimeLineListPEC_CancelledNotification(env, notification, index, recipient);
